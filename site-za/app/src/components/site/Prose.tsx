...
/** Long-form copy: either structured sections or arbitrary children, styled by .c-prose. */
export function Prose({ sections, children }: { sections?: { heading?: string; paragraphs: string[] }[]; children?: ReactNode }) {
  if (children) return <div className="c-prose">{children}</div>;
  return (
